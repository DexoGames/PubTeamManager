...
{
    // Generates a round-robin fixture list where each team plays each other home and away once
    public static List<MatchWeek> GenerateFixtures(List<Team> teams, DateTime startDate)
    {
